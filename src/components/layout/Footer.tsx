...
const footerItems = {
  ...
  social: [
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/earthtojohn/',
      icon: (props: any) => (
...
export default function Footer() {
  ...
  return (
    <footer className="bg-white">
      <div className="mx-auto max-w-7xl overflow-hidden px-4 pt-12 pb-10 sm:px-6 lg:px-8">
        <nav
        ...
        <p className="mt-8 text-center text-base text-stone-600">
          &copy; {new Date().getFullYear()}
          {` `}
          Carman Fine Arts. All rights reserved.
        </p>
      </div>
    </footer>
  );
